    ...
    for scenario in scenarios:
        ...
        for step in scenario.steps:
            ...
            if step.id == 1:
                ...
                scenario_file.write('using System;\n')
                scenario_file.write('namespace GrcTest\n{\n')
                scenario_file.write('    public class Scenario_%s \n    {\n\n' % scenario.id)
                scenario_file.write('        public void Main()\n        {\n\n')

            scenario_file.write('            System.console.WriteLine("%s. %s ---> %s");\n' % (step.id, step.action.label.replace('\n', ''), step.node.label.replace('\n', '')))
